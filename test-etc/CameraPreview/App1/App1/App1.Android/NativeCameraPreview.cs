...
{
    public class NativeCameraPreview : ViewGroup, ISurfaceHolderCallback, Camera.IShutterCallback, Camera.IPictureCallback
    {
        ...
        public CameraOptions CameraOption
        {
            ...
            set
            {
                ...
                SurfaceChanged(holder, Android.Graphics.Format.Jpeg, beginWidth, beginHeight);
